...
exports.REGISTRY_BASELINE = exports.I18N = exports.API_CONFIG = exports.WORKER_CONFIG = exports.SOCKET_CONFIG = exports.DATABASE_CONFIG = exports.SYSTEM_SETTING = exports.I18N_CONFIG = exports.FILE_CONFIG = exports.EMAIL_TEMPLATE = exports.INTEGRATION = exports.AUTH_CONFIG = exports.AI_PROMPT = exports.AI_CONFIG = exports.THEME = exports.DASHBOARD = exports.ENTITY_CONFIG = exports.MARKETPLACE_TEMPLATE = exports.CONSTANT = exports.SHORTCUT = exports.NAV = exports.SYSTEM_ROLE = exports.COMMON_PRIORITY = exports.COMMON_STATUS = exports.COMMON_COLOR = void 0;
// ============================================================================
// HELPERS
// ============================================================================
/**
...
exports.COMMON_STATUS = {
    active: { label: { ro: 'Activ', en: 'Active' }, value: 'active', color: exports.COMMON_COLOR.emerald },
    archived: { label: { ro: 'Arhivat', en: 'Archived' }, value: 'archived', color: exports.COMMON_COLOR.amber },
    deleted: { label: { ro: 'Șters', en: 'Deleted' }, value: 'deleted', color: exports.COMMON_COLOR.red },
    planning: { label: { ro: 'În Planificare', en: 'Planning' }, value: 'planning', color: exports.COMMON_COLOR.indigo },
    blocked: { label: { ro: 'Blocat', en: 'Blocked' }, value: 'blocked', color: exports.COMMON_COLOR.red },
    completed: { label: { ro: 'Finalizat', en: 'Completed' }, value: 'completed', color: exports.COMMON_COLOR.slate },
    lead: { label: { ro: 'Lead', en: 'Lead' }, value: 'lead', color: exports.COMMON_COLOR.blue },
    customer: { label: { ro: 'Client', en: 'Customer' }, value: 'customer', color: exports.COMMON_COLOR.emerald },
    partner: { label: { ro: 'Partener', en: 'Partner' }, value: 'partner', color: exports.COMMON_COLOR.violet },
    vendor: { label: { ro: 'Furnizor', en: 'Vendor' }, value: 'vendor', color: exports.COMMON_COLOR.amber },
    todo: { label: { ro: 'De făcut', en: 'To Do' }, value: 'todo', color: exports.COMMON_COLOR.slate },
    in_progress: { label: { ro: 'În lucru', en: 'In Progress' }, value: 'in_progress', color: exports.COMMON_COLOR.blue },
    done: { label: { ro: 'Gata', en: 'Done' }, value: 'done', color: exports.COMMON_COLOR.emerald },
};
exports.COMMON_PRIORITY = {
    low: { label: { ro: 'Scăzută', en: 'Low' }, value: 'low', color: exports.COMMON_COLOR.slate },
    medium: { label: { ro: 'Medie', en: 'Medium' }, value: 'medium', color: exports.COMMON_COLOR.amber },
    high: { label: { ro: 'Urgentă', en: 'High' }, value: 'high', color: exports.COMMON_COLOR.red },
};
exports.SYSTEM_ROLE = {
    superadmin: {
        label: { ro: 'SuperAdmin', en: 'SuperAdmin' },
        color: exports.COMMON_COLOR.red,
    ...
    workspace_owner: {
        ...
        color: exports.COMMON_COLOR.indigo,
        ...
        allowedPage: ['dashboard', 'monitoring', 'settings', 'profile', 'entity', 'worker'],
    },
    workspace_admin: {
        label: { ro: 'Administrator', en: 'Workspace Admin' },
        color: exports.COMMON_COLOR.violet,
    ...
    member: {
        ...
        color: exports.COMMON_COLOR.emerald,
    ...
    agent: {
        ...
        color: exports.COMMON_COLOR.orange,
    ...
    guest: {
        ...
        color: exports.COMMON_COLOR.gray,
        ...
        entity: [
            {
                ...
                fields: {
                    ...
                    status: {
                        ...
                        options: [
                            exports.COMMON_STATUS.planning,
                            exports.COMMON_STATUS.active,
                            exports.COMMON_STATUS.blocked,
                            exports.COMMON_STATUS.completed
                        ]
                    },
            ...
            },
            {
                ...
                fields: {
                    ...
                    priority: { type: 'enum', label: { ro: 'Prioritate', en: 'Priority' }, options: [exports.COMMON_PRIORITY.low, exports.COMMON_PRIORITY.medium, exports.COMMON_PRIORITY.high] },
                    status: { type: 'enum', label: { ro: 'Status', en: 'Status' }, options: [exports.COMMON_STATUS.todo, exports.COMMON_STATUS.in_progress, exports.COMMON_STATUS.done] }
                }
            }
        ]
    },
...
exports.ENTITY_CONFIG = {
    contact: {
        ...
        fields: {
            ...
            status: {
                type: 'enum',
                options: [
                    exports.COMMON_STATUS.lead,
                    exports.COMMON_STATUS.customer,
                    exports.COMMON_STATUS.partner,
                    exports.COMMON_STATUS.vendor
                ],
                defaultValue: 'lead',
                ui: { width: 6 }
            },
            role: {
                type: 'enum',
                options: [
                    { value: 'superadmin', label: exports.SYSTEM_ROLE.superadmin.label, color: exports.SYSTEM_ROLE.superadmin.color },
                    { value: 'workspace_owner', label: exports.SYSTEM_ROLE.workspace_owner.label, color: exports.SYSTEM_ROLE.workspace_owner.color },
                    { value: 'workspace_admin', label: exports.SYSTEM_ROLE.workspace_admin.label, color: exports.SYSTEM_ROLE.workspace_admin.color },
                    { value: 'member', label: exports.SYSTEM_ROLE.member.label, color: exports.SYSTEM_ROLE.member.color },
                    { value: 'agent', label: exports.SYSTEM_ROLE.agent.label, color: exports.SYSTEM_ROLE.agent.color },
                    { value: 'guest', label: exports.SYSTEM_ROLE.guest.label, color: exports.COMMON_COLOR.gray }
                ],
                defaultValue: 'guest',
                ui: { width: 6 }
            },
    ...
    workspace: {
        ...
        fields: {
            ...
            status: {
                type: 'enum',
                options: [
                    exports.COMMON_STATUS.archived,
                    exports.COMMON_STATUS.deleted
                ],
                defaultValue: 'active',
                ui: { width: 6 }
            },
    ...
    task: {
        ...
        fields: {
            ...
            status: { type: 'enum', options: [exports.COMMON_STATUS.todo, exports.COMMON_STATUS.in_progress, exports.COMMON_STATUS.done], defaultValue: 'todo' },
            priority: { type: 'enum', options: [exports.COMMON_PRIORITY.low, exports.COMMON_PRIORITY.medium, exports.COMMON_PRIORITY.high], defaultValue: 'medium' },
...
exports.REGISTRY_BASELINE = {
    __version__: exports.CONSTANT.app.version,
    __lastUpdated__: new Date().toISOString(),
    __environment__: safeEnv('NODE_ENV', 'development'),
    // Top-level Config (Visible in GENERAL)
    appName: exports.SYSTEM_SETTING.workspace_name,
    appLogo: exports.SYSTEM_SETTING.logo_url,
    appVersion: exports.CONSTANT.app.version,
    appDescription: exports.CONSTANT.app.description,
    appUrl: exports.CONSTANT.directories.baseUrl,
    language: exports.I18N_CONFIG.defaultLanguage,
    timezone: exports.I18N_CONFIG.timezone.default,
    maintenanceMode: exports.SYSTEM_SETTING.app.maintenanceMode,
    debugMode: exports.SYSTEM_SETTING.app.debugMode,
    NAV: exports.NAV,
    SHORTCUT: exports.SHORTCUT,
    CONSTANT: exports.CONSTANT,
    ENTITY_CONFIG: exports.ENTITY_CONFIG,
    SYSTEM_ROLE: exports.SYSTEM_ROLE,
    DASHBOARD: exports.DASHBOARD,
    THEME: exports.THEME,
    AI_CONFIG: exports.AI_CONFIG,
    AI_PROMPT: exports.AI_PROMPT,
    AUTH_CONFIG: exports.AUTH_CONFIG,
    INTEGRATION: exports.INTEGRATION,
    EMAIL_TEMPLATE: exports.EMAIL_TEMPLATE,
    FILE_CONFIG: exports.FILE_CONFIG,
    I18N_CONFIG: exports.I18N_CONFIG,
    I18N: exports.I18N,
    SYSTEM_SETTING: exports.SYSTEM_SETTING,
    DATABASE_CONFIG: exports.DATABASE_CONFIG,
    SOCKET_CONFIG: exports.SOCKET_CONFIG,
    WORKER_CONFIG: exports.WORKER_CONFIG,
    API_CONFIG: exports.API_CONFIG,
    MARKETPLACE_TEMPLATE: exports.MARKETPLACE_TEMPLATE,
};
exports.default = exports.REGISTRY_BASELINE;
//# sourceMappingURL=registry-baseline.js.map