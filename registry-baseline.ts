...
export const I18N = {
  ...
  ro: {
    common: {
      ...
      confirm_delete: "Ești sigur că vrei să ștergi această înregistrare? Această acțiune este ireversibilă.",
      not_found: "Înregistrarea nu a fost găsită",
      error_loading: "Eroare la încărcarea datelor",
      validation_error: "Te rugăm să corectezi erorile din formular",
      restore_success: "Date restaurate cu succes",
      restore_error: "Eroare la restaurare",
      confirm_restore: "Ești sigur că vrei să restaurezi această versiune? Datele actuale vor fi suprascrise.",
      missing_phone: "Număr de telefon lipsă",
      missing_email: "Adresă de email lipsă",
      missing_url: "Adresă URL lipsă",
      ai_extraction_title: "Smart Extractor",
      ai_extraction_subtitle: "Extrage date din orice sursă automat",
      paste_label: "Lipește conținutul mai jos",
      paste_placeholder: "Lipește un e-mail, un mesaj sau o descriere aici...",
      select_doc: "Selectează Document",
      doc_hint: "Suportă PDF, JPG, PNG sau DOCX",
      file_analyzing: "Fișier încărcat. Analizăm...",
      latest_messages: "Ultimele mesaje",
      extract_btn: "Începe Extracția AI",
      ai_hint: "AI va genera acest câmp automat...",
      rbac_label: "Enterprise Level 8 RBAC",
      global: "Global",
      role: {
        superadmin: "Super Admin",
